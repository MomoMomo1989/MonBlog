          ...
          <div class="flex items-center justify-between gap-8 mb-8">
            ...
            <div class="w-full max-w-sm min-w-[200px]">
                <div class="relative flex items-center">
                  ...
                  <input wire:model='search' wire:keydown.enter='searchBrands'
                  class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md pl-10 pr-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
                  placeholder="Votre recherche ici..." 
                  />
                  
                  <button wire:click="searchBrands" type="button"
...
<tr>
  ...
  <td class="p-2 w-[100px] border-b border-blue-gray-50 " x-data="{modalIsOpen: false}" >
    <x-modal.update-marque id="{{ $item->id }}" />
